...
--
-- Host: localhost
-- Generation Time: May 05, 2024 at 07:33 PM
...
CREATE TABLE `bieumaunhap` (
  ...
  KEY `FK_bieumaunhap_longuyenvatlieu` (`maKho`),
...
INSERT INTO `bieumaunhap` (`maBMNhap`, `maDeXuat`, `maKho`, `tenNguoiGiao`, `ngayNhap`, `loaiNhap`, `trangThai`) VALUES
('BMN01', NULL, 'KNVL01', 'Lê Anh Nuôi', '2024-01-01', 'Nguyên Vật Liệu', 'Đã lập phiếu'),
('BMN02', NULL, 'KNVL02', 'Bùi Thục Đoan', '2024-01-01', 'Nguyên Vật Liệu', 'Đã lập phiếu'),
('BMN03', NULL, 'KNVL03', 'Lê Hải Đăng', '2024-01-01', 'Nguyên Vật Liệu', 'Đã lập phiếu'),
('BMN04', NULL, 'KNVL04', 'Lê Anh Nuôi', '2024-01-01', 'Nguyên Vật Liệu', 'Đã lập phiếu'),
('BMN05', NULL, 'KNVL05', 'Lê Hải Đăng', '2024-01-01', 'Nguyên Vật Liệu', 'Đã lập phiếu'),
('BMN06', NULL, 'KNVL06', 'Lê Hải Đăng', '2024-01-01', 'Nguyên Vật Liệu', 'Đã lập phiếu'),
('BMN07', NULL, 'KNVL01', 'ABC', '2024-01-01', 'Nguyên Vật Liệu', 'Đã lập phiếu'),
('BMN08', 'DX06', 'KNVL02', '1', '2024-05-05', 'Nguyên vật liệu', 'Chưa lập phiếu'),
('BMN09', 'DX06', 'KNVL02', '123', '2024-05-05', 'Nguyên vật liệu', 'Chưa lập phiếu'),
('BMN10', 'DX06', 'KNVL02', '123', '2024-05-25', 'Nguyên vật liệu', 'Chưa lập phiếu'),
('BMN11', 'DX07', 'KNVL06', 'dddd', '2024-05-05', 'Nguyên vật liệu', 'Đã lập phiếu');
...
INSERT INTO `chitietbieumaunhap` (`maBMNhap`, `tenSanPham`, `donViTinh`, `soLuong`, `ngaySanXuat`, `ngayHetHan`) VALUES
('BMN01', 'Sữa tươi', 'Gói', 10000, NULL, NULL),
('BMN01', 'Đường', 'Gói', 10000, NULL, NULL),
('BMN03', 'Chất tạo ngọt', 'Gói', 10000, NULL, NULL),
('BMN03', 'Màu thực vật', 'Chai', 10000, NULL, NULL),
('BMN04', 'Bột', 'Gói', 10000, NULL, NULL),
('BMN04', 'Trứng gà', 'Vỉ', 10000, NULL, NULL),
('BMN05', 'Chocolate', 'Hộp', 10000, NULL, NULL),
('BMN05', 'Ớt bột', 'Gói', 10000, NULL, NULL),
('BMN06', 'Bơ đậu phộng', 'Hủ', 10000, NULL, NULL),
('BMN06', 'Mứt dâu', 'Hủ', 10000, NULL, NULL),
('BMN02', 'Siro dâu', 'Chai', 10000, NULL, NULL),
('BMN02', 'Muối', 'Gói', 10000, NULL, NULL),
('BMN07', 'Sữa tươi', 'Gói', 1000, NULL, NULL),
('BMN10', 'Muối', 'Gói', 100, NULL, NULL),
('BMN11', 'Mứt dâu', 'Hủ', 1000, NULL, NULL);
...
('KTP03', 'NVK02', 'Kho Thành Phẩm 03', 'Phường 15, Gò Vấp', 500, 'Hoạt động', 10),
('KTP04', 'NVK03', 'Kho Thành Phẩm 04', 'Phường 15, Gò Vấp', 500, 'Hoạt động', 10),
('KTP05', 'NVK03', 'Kho Thành Phẩm 05', 'Phường 15, Gò Vấp', 500, 'Hoạt động', 10),
('KTP06', 'NVK03', 'Kho Thành Phẩm 06', 'Phường 15, Gò Vấp', 500, 'Hoạt động', 10);
...
('LNVL03', 'NVL03', 'BMN02', 'PNNVL09', NULL, 10000, '2024-05-05', '2024-05-30', 'KNVL02', NULL, NULL, NULL, NULL),
('LNVL04', 'NVL04', 'BMN02', 'PNNVL09', NULL, 10000, '2024-05-05', '2024-05-30', 'KNVL02', NULL, NULL, NULL, NULL),
('LNVL06', 'NVL06', 'BMN03', 'PNNVL10', NULL, 10000, '2024-05-05', '2024-05-31', 'KNVL03', NULL, NULL, NULL, NULL),
('LNVL09', 'NVL09', 'BMN05', 'PNNVL12', NULL, 10000, '2024-05-05', '2024-05-31', 'KNVL05', NULL, NULL, NULL, NULL),
('LNVL10', 'NVL10', 'BMN05', 'PNNVL12', NULL, 10000, '2024-05-05', '2024-05-31', 'KNVL05', NULL, NULL, NULL, NULL),
('LNVL11', 'NVL11', 'BMN06', 'PNNVL13', NULL, 10000, '2024-05-05', '2024-05-31', 'KNVL06', NULL, NULL, NULL, NULL),
('LNVL12', 'NVL12', 'BMN06', 'PNNVL13', NULL, 10000, '2024-05-05', '2024-05-31', 'KNVL06', NULL, NULL, NULL, NULL),
('LNVL13', 'NVL12', 'BMN11', 'PNNVL14', NULL, 1000, '2024-05-05', '2024-05-30', 'KNVL06', NULL, NULL, NULL, NULL);
...
('NVL02', 'Đường', 'Gói', 20000, 'duong.jpg', 0, 1),
('NVL03', 'Siro Dâu', 'Chai', 20000, 'sirodau.jpg', 0, 1),
('NVL04', 'Muối', 'Gói', 20000, 'duong.jpg', 0, 1),
('NVL05', 'Chất tạo ngọt', 'Gói', 20000, 'chattaongot.jpg', 0, 1),
('NVL06', 'Màu thực vật', 'Chai', 20000, 'mauthucvat.jpg', 0, 1),
('NVL07', 'Bột ', 'Gói', 20000, 'bot.jpg', 0, 1),
('NVL08', 'Trứng gà', 'Vỉ', 20000, 'trungga.jpg', 0, 1),
('NVL09', 'Chocolate', 'Hộp', 20000, 'chocolate.jpg', 0, 1),
('NVL10', 'Ớt bột', 'Gói', 20000, 'otbot.jpg', 0, 1),
('NVL11', 'Bơ đậu phộng', 'Hủ', 20000, 'bodauphong.jpg', 0, 1),
('NVL12', 'Mứt dâu', 'Hủ', 21000, 'mutdau.jpg', 0, 1);
...
('NVK01', 'Nguyễn Thị Tuyết Hoa', '0338459237', 'tuyethoant2016@gmail.com'),
('NVK02', 'Lê Hạnh Hải Đăng', '0833109609', 'lehanhhaidang@gmail.com'),
('NVK03', 'Đặng Thị Thiện Hảo', '0123456789', 'abc@gmail.com');
...
('NVKK07', 'KTP03', 'Nguyễn Tấn Đạt', '0372283331', 'dat@gmail.com'),
('NVKK08', 'KTP04', 'Hà Thanh Mai', '0989977745', 'mai@gmail.com'),
('NVKK09', 'KTP05', 'Lê Thị B', '0375583771', 'bb@gmail.com'),
('NVKK10', 'KTP06', 'Bùi Thị Hương', '0387496851', 'huong@gmail.com');
...
(1, 'Nhân Viên Kho 1', 'nvk1@gmail.com', '827ccb0eea8a706c4c34a16891f84e7b', '', NULL, NULL, 'nhanvienkho', 'hoatdong', '2024-04-17 03:40:45'),
...
ALTER TABLE `bieumaunhap`
  ...
  ADD CONSTRAINT `FK_bieumaunhap_kho` FOREIGN KEY (`maKho`) REFERENCES `kho` (`maKho`) ON DELETE CASCADE ON UPDATE CASCADE;
